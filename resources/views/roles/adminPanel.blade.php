...
@section('content')
    ...
    <div style="background-color: white; text-align: center; margin-bottom: 90px; padding-top: 25px; height: 100%;">
        @if(Auth::user()->admin !== "yes")
            <button type="button" class="btn btn-primary" style="margin-top: 100px;" data-bs-toggle="modal" data-bs-target="#exampleModal">Add new worker or import</button><hr />
        @endif
    ...
    @if(Auth::user()->admin !== "yes")
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" style="margin-left: 3%; height: 100%; margin-top: 80px">
    ...
    <script>
        ...
        let number_in_table = document.querySelectorAll(".number_in_table");
        let nT = 1;
