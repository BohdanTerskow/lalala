...
@section("content")
    ...
    <div style="background-color: white; text-align: center; padding-top: 15px;">
        @if(Auth::user()->tariff === 1)
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" style="margin-top: 100px;">Add new department</button><hr />
        ...
        <div id="users-table">
            <table class="table table-striped table-sm bg-white" @if(Auth::user()->tariff !== 1)style="margin-top: 100px;"@endif>
                <thead>
                <tr>
                    <th scope="col">#</th>
