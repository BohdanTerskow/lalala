            ...
            <div class="sidebar-menu-wrapper">
                <div class="side-menu-cart1">
                    ...
                    <div class="side-menu-trends-proj">
                        ...
                        @if(Auth::user()->admin === "yes")
                            <div class="side-menu-companies-link">
                                <div style="margin-top: 5px;">
                                    <select class="existCompanies form-select" style="width: 130px; font-size: 10px;">
                                        <option value="Choose company:" selected disabled>Check company:</option>
                                        @foreach($companies as $company)
                                            <option value="{{$company->title}}">{{$company->title}}</option>
                                        @endforeach
                                    </select><br />
                                    <a href="" class="btn btn-light btn-sm getCompanyResults" style=" width: 100px; margin-left: 0px; margin-top: -10px;">GET DATA</a>
                                    <a href="" class="btn btn-secondary btn-sm disabled getCompanyResultsDisabled" tabindex="-1" role="button" aria-disabled="true" style=" width: 100px; display: none;margin-top: -10px; margin-left: 0px;">GET DATA</a>
                                </div>
                            </div>
                            <script>
                                            ...
                                            responses.forEach(el => {
                                                    ...
                                                    @if(Auth::user()->manager === "yes")
                                                {
                                                    if (el["values"]["QID101_TEXT"] == "{{Auth::user()->company_title}}") {
                                                        ...
                                                        sessionStorage.setItem("storageGapReportCompany", JSON.stringify(objReportDate))
                                                        /*END GAP REPORT LOGIC CODE*/
                                                    ...
                                                    @elseif(Auth::user()->teamlead === "yes")
                                                {
                                                    if (el["values"]["QID101_TEXT"] == "{{Auth::user()->company_title}}" && el["values"]["QID103_TEXT"] == "{{Auth::user()->name}}") {
                                                        ...
                                                        sessionStorage.setItem("storageGapReportTeam", JSON.stringify(objReportDate))
